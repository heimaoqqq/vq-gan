...
class Unet(nn.Module):
    ...
    def forward_with_cond_scale(
        ...
        **kwargs
        ...
        if cond_scale == 1:
            # Baseline模式：返回条件输出和None（或相同的logits）
...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        *,
        ...
        auto_normalize = True  # auto-normalize data [0,1] -> [-1,1], set False for latent diffusion
    ):
        super().__init__()
        ...
        # auto-normalization control for latent diffusion
